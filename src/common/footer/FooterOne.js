                        ...
                        <div className="col-xl-6 col-lg-5">
                            <div className="footer-widget border-end">
                                <div className="footer-newsletter">
                                    ...
                                    <p>Get in touch with us for innovative, high-quality software solutions tailored to your unique needs.</p>
                                    <form>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()}. All rights reserved by <a href="https://theappops.com">TheAppOps</a>.</span>
                            </div>
                        </div>
                        <div className="col-md-6">
